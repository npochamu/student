			...
			<form action="SubjectCreateComplete" method="post">
				<div class="mb-3 col-6">
					...
					<input type="text" id="subCd" name="subCd" class="form-control"
						...
						placeholder="科目コードを入力してください" class="form-control" required>
						<small class="form-text text-muted">※3文字の半角英数字</small>
<!-- 						pattern="[a-zA-Z0-9]{3}"  title="科目コードは3文字の半角英数字で入力してください" -->
				<!-- 科目コード重複のメッセージ（insert実行前にselect～where文バージョンでのチェック）＆科目コード文字数チェック -->
